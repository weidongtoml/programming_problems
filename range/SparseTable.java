 ...
 * and utility this precomputed table to answer the given range query.
 * e.g.
 *   to calculate F(Arr_i, ..., Arr_(i+12))
 *   let
 *      x1 = F(Arr_i, ..., Arr_(i+7)) = table[i][3]
 *      x2 = F(Arr_(i+8), ..., Arr_(i+11)) = table[i+8][2]
 *      x3 = F(Arr_(i+12) = table[i+12][0]
 *   then
